class Training:
    ...
    def train_haiku(haiku, monograms, bi-grams, line_types):
        ...
        and one of Line_type objects. Updates the Monogram set and the Bi-Gram set, returns unit."""

    def train (haikus, monograms, bi-grams, line_types):
        """Trains the input haikus, updates monograms and bigrams, yields units"""
